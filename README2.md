...
│   ├── Modulo2_PlanillaDeAmasados.bas   # Genera las planillas de amasado por producto
│   ├── Modulo3_PlanillaFCA.bas          # Versión histórica (2008) del generador diario
│   ├── Modulo4_PlanillasDeProceso.bas   # Genera fermentación, cocción, abatimiento y envasado
│   ├── UserForm3_Menu.bas               # Menú principal
│   └── ThisWorkbook.bas                 # Inicialización y limpieza al abrir el libro
└── README.md
```
